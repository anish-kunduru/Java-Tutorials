...
namespace InfoHub.InfoHub_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_11_ArticleBase() { return new global::InfoHub.Articles.ArticleBase(); }

        private object Activate_14_SnapConverter() { return new global::InfoHub.Helpers.SnapConverter(); }

        private object Activate_15_BooleanToVisibilityConverter() { return new global::InfoHub.Common.BooleanToVisibilityConverter(); }
        ...
        private object Activate_20_AppHub() { return new global::InfoHub.AppHub(); }

        private object Activate_21_ExtendedStart() { return new global::InfoHub.ExtendedStart(); }

        private object Activate_22_Privacy() { return new global::InfoHub.Privacy(); }

        private object Activate_23_AdControl() { return new global::Microsoft.Advertising.WinRT.UI.AdControl(); }

        private object Activate_26_DateStringConverter() { return new global::InfoHub.Helpers.DateStringConverter(); }
        ...
        private global::Windows.UI.Xaml.Markup.IXamlType CreateXamlType(string typeName)
        {
            ...
            case "InfoHub.Articles.ArticleBase":
                userType = new global::InfoHub.InfoHub_XamlTypeInfo.XamlUserType(this, typeName, typeof(global::InfoHub.Articles.ArticleBase), GetXamlTypeByName("Object"));
                userType.Activator = Activate_11_ArticleBase;
                xamlType = userType;
                break;
            ...
            case "InfoHub.Helpers.SnapConverter":
                ...
                userType.Activator = Activate_14_SnapConverter;
                xamlType = userType;
                break;
            ...
            case "InfoHub.AppHub":
                userType = new global::InfoHub.InfoHub_XamlTypeInfo.XamlUserType(this, typeName, typeof(global::InfoHub.AppHub), GetXamlTypeByName("InfoHub.Common.LayoutAwarePage"));
                userType.Activator = Activate_20_AppHub;
                xamlType = userType;
                break;
            ...
            case "InfoHub.ExtendedStart":
                ...
                userType.Activator = Activate_21_ExtendedStart;
                xamlType = userType;
                break;
            ...
            case "InfoHub.Helpers.DateStringConverter":
                ...
                userType.Activator = Activate_26_DateStringConverter;
                xamlType = userType;
                break;
        ...
        private object get_18_AppHubViewModel_SelectedArticle(object instance)
        {
            var that = (global::InfoHub.AppHubViewModel)instance;
            return that.SelectedArticle;
        }
        private void set_18_AppHubViewModel_SelectedArticle(object instance, object Value)
        {
            var that = (global::InfoHub.AppHubViewModel)instance;
            that.SelectedArticle = (global::InfoHub.Articles.ArticleBase)Value;
        }
        private object get_19_AppHubViewModel_ReloadAllCommand(object instance)
        {
            var that = (global::InfoHub.AppHubViewModel)instance;
            return that.ReloadAllCommand;
        }
        private object get_20_AppHubViewModel_LoadFeedCommand(object instance)
        {
            var that = (global::InfoHub.AppHubViewModel)instance;
            return that.LoadFeedCommand;
        }
        private object get_21_AppHubViewModel_HideAds(object instance)
        {
            var that = (global::InfoHub.AppHubViewModel)instance;
            return that.HideAds;
        }
        private void set_21_AppHubViewModel_HideAds(object instance, object Value)
        {
            var that = (global::InfoHub.AppHubViewModel)instance;
            that.HideAds = (global::System.Boolean)Value;
        }
        private object get_22_AppHubViewModel_PurchaseHideAdsCommand(object instance)
        {
            var that = (global::InfoHub.AppHubViewModel)instance;
            return that.PurchaseHideAdsCommand;
        }
        private object get_23_TemplateSelector_AdvertTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.AdvertTemplateHero;
        }
        private void set_23_TemplateSelector_AdvertTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.AdvertTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_24_TemplateSelector_AdvertTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.AdvertTemplateNormal;
        }
        private void set_24_TemplateSelector_AdvertTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.AdvertTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_25_TemplateSelector_CalendarTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.CalendarTemplateHero;
        }
        private void set_25_TemplateSelector_CalendarTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.CalendarTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_26_TemplateSelector_CalendarTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.CalendarTemplateNormal;
        }
        private void set_26_TemplateSelector_CalendarTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.CalendarTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_27_TemplateSelector_FlickrTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.FlickrTemplateHero;
        }
        private void set_27_TemplateSelector_FlickrTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.FlickrTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_28_TemplateSelector_FlickrTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.FlickrTemplateNormal;
        }
        private void set_28_TemplateSelector_FlickrTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.FlickrTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_29_TemplateSelector_NewsTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.NewsTemplateHero;
        }
        private void set_29_TemplateSelector_NewsTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.NewsTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_30_TemplateSelector_NewsTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.NewsTemplateNormal;
        }
        private void set_30_TemplateSelector_NewsTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.NewsTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_31_TemplateSelector_SummaryTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.SummaryTemplateHero;
        }
        private void set_31_TemplateSelector_SummaryTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.SummaryTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_32_TemplateSelector_SummaryTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.SummaryTemplateNormal;
        }
        private void set_32_TemplateSelector_SummaryTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.SummaryTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_33_TemplateSelector_TwitterTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.TwitterTemplateHero;
        }
        private void set_33_TemplateSelector_TwitterTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.TwitterTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_34_TemplateSelector_TwitterTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.TwitterTemplateNormal;
        }
        private void set_34_TemplateSelector_TwitterTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.TwitterTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_35_TemplateSelector_WeatherTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.WeatherTemplateHero;
        }
        private void set_35_TemplateSelector_WeatherTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.WeatherTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_36_TemplateSelector_WeatherTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.WeatherTemplateNormal;
        }
        private void set_36_TemplateSelector_WeatherTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.WeatherTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_37_TemplateSelector_YouTubeTemplateHero(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.YouTubeTemplateHero;
        }
        private void set_37_TemplateSelector_YouTubeTemplateHero(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.YouTubeTemplateHero = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_38_TemplateSelector_YouTubeTemplateNormal(object instance)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            return that.YouTubeTemplateNormal;
        }
        private void set_38_TemplateSelector_YouTubeTemplateNormal(object instance, object Value)
        {
            var that = (global::InfoHub.Helpers.TemplateSelector)instance;
            that.YouTubeTemplateNormal = (global::Windows.UI.Xaml.DataTemplate)Value;
        }
        private object get_39_AdControl_Latitude(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.Latitude;
        }
        private void set_39_AdControl_Latitude(object instance, object Value)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            that.Latitude = (global::System.Double)Value;
        }
        private object get_40_AdControl_Longitude(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.Longitude;
        }
        private void set_40_AdControl_Longitude(object instance, object Value)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            that.Longitude = (global::System.Double)Value;
        }
        private object get_41_AdControl_AdUnitId(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.AdUnitId;
        }
        private void set_41_AdControl_AdUnitId(object instance, object Value)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            that.AdUnitId = (global::System.String)Value;
        }
        private object get_42_AdControl_ApplicationId(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.ApplicationId;
        }
        private void set_42_AdControl_ApplicationId(object instance, object Value)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            that.ApplicationId = (global::System.String)Value;
        }
        private object get_43_AdControl_IsEngaged(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.IsEngaged;
        }
        private object get_44_AdControl_IsAutoRefreshEnabled(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.IsAutoRefreshEnabled;
        }
        private void set_44_AdControl_IsAutoRefreshEnabled(object instance, object Value)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            that.IsAutoRefreshEnabled = (global::System.Boolean)Value;
        }
        private object get_45_AdControl_IsPerformanceScrollingEnabled(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.IsPerformanceScrollingEnabled;
        }
        private void set_45_AdControl_IsPerformanceScrollingEnabled(object instance, object Value)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            that.IsPerformanceScrollingEnabled = (global::System.Boolean)Value;
        }
        private object get_46_AdControl_UseStaticAnchor(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            return that.UseStaticAnchor;
        }
        private void set_46_AdControl_UseStaticAnchor(object instance, object Value)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
            that.UseStaticAnchor = (global::System.Boolean)Value;
        }
        private object get_47_AdControl_IsSuspended(object instance)
        {
            var that = (global::Microsoft.Advertising.WinRT.UI.AdControl)instance;
        ...
        private object get_49_Color_B(object instance)
        {
            var that = (global::Windows.UI.Color)instance;
            return that.B;
        }
        private void set_49_Color_B(object instance, object Value)
        {
            var that = (global::Windows.UI.Color)instance;
        ...
        private object get_51_Color_R(object instance)
        {
            var that = (global::Windows.UI.Color)instance;
            return that.R;
        }
        private void set_51_Color_R(object instance, object Value)
        {
            var that = (global::Windows.UI.Color)instance;
        ...
        private global::Windows.UI.Xaml.Markup.IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            case "InfoHub.AppHubViewModel.SelectedArticle":
                userType = (global::InfoHub.InfoHub_XamlTypeInfo.XamlUserType)GetXamlTypeByName("InfoHub.AppHubViewModel");
                xamlMember = new global::InfoHub.InfoHub_XamlTypeInfo.XamlMember(this, "SelectedArticle", "InfoHub.Articles.ArticleBase");
                xamlMember.Getter = get_18_AppHubViewModel_SelectedArticle;
                xamlMember.Setter = set_18_AppHubViewModel_SelectedArticle;
                break;
            case "InfoHub.AppHubViewModel.ReloadAllCommand":
                ...
                xamlMember.Getter = get_19_AppHubViewModel_ReloadAllCommand;
                xamlMember.SetIsReadOnly();
                break;
            case "InfoHub.AppHubViewModel.LoadFeedCommand":
                ...
                xamlMember.Getter = get_20_AppHubViewModel_LoadFeedCommand;
                xamlMember.SetIsReadOnly();
                break;
            case "InfoHub.AppHubViewModel.HideAds":
                userType = (global::InfoHub.InfoHub_XamlTypeInfo.XamlUserType)GetXamlTypeByName("InfoHub.AppHubViewModel");
                xamlMember = new global::InfoHub.InfoHub_XamlTypeInfo.XamlMember(this, "HideAds", "Boolean");
                xamlMember.Getter = get_21_AppHubViewModel_HideAds;
                xamlMember.Setter = set_21_AppHubViewModel_HideAds;
                break;
            case "InfoHub.AppHubViewModel.PurchaseHideAdsCommand":
                ...
                xamlMember.Getter = get_22_AppHubViewModel_PurchaseHideAdsCommand;
                xamlMember.SetIsReadOnly();
                break;
            case "InfoHub.Helpers.TemplateSelector.AdvertTemplateHero":
                ...
                xamlMember.Getter = get_23_TemplateSelector_AdvertTemplateHero;
                xamlMember.Setter = set_23_TemplateSelector_AdvertTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.AdvertTemplateNormal":
                ...
                xamlMember.Getter = get_24_TemplateSelector_AdvertTemplateNormal;
                xamlMember.Setter = set_24_TemplateSelector_AdvertTemplateNormal;
                break;
            case "InfoHub.Helpers.TemplateSelector.CalendarTemplateHero":
                ...
                xamlMember.Getter = get_25_TemplateSelector_CalendarTemplateHero;
                xamlMember.Setter = set_25_TemplateSelector_CalendarTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.CalendarTemplateNormal":
                ...
                xamlMember.Getter = get_26_TemplateSelector_CalendarTemplateNormal;
                xamlMember.Setter = set_26_TemplateSelector_CalendarTemplateNormal;
                break;
            case "InfoHub.Helpers.TemplateSelector.FlickrTemplateHero":
                ...
                xamlMember.Getter = get_27_TemplateSelector_FlickrTemplateHero;
                xamlMember.Setter = set_27_TemplateSelector_FlickrTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.FlickrTemplateNormal":
                ...
                xamlMember.Getter = get_28_TemplateSelector_FlickrTemplateNormal;
                xamlMember.Setter = set_28_TemplateSelector_FlickrTemplateNormal;
                break;
            case "InfoHub.Helpers.TemplateSelector.NewsTemplateHero":
                ...
                xamlMember.Getter = get_29_TemplateSelector_NewsTemplateHero;
                xamlMember.Setter = set_29_TemplateSelector_NewsTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.NewsTemplateNormal":
                ...
                xamlMember.Getter = get_30_TemplateSelector_NewsTemplateNormal;
                xamlMember.Setter = set_30_TemplateSelector_NewsTemplateNormal;
                break;
            case "InfoHub.Helpers.TemplateSelector.SummaryTemplateHero":
                ...
                xamlMember.Getter = get_31_TemplateSelector_SummaryTemplateHero;
                xamlMember.Setter = set_31_TemplateSelector_SummaryTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.SummaryTemplateNormal":
                ...
                xamlMember.Getter = get_32_TemplateSelector_SummaryTemplateNormal;
                xamlMember.Setter = set_32_TemplateSelector_SummaryTemplateNormal;
                break;
            case "InfoHub.Helpers.TemplateSelector.TwitterTemplateHero":
                ...
                xamlMember.Getter = get_33_TemplateSelector_TwitterTemplateHero;
                xamlMember.Setter = set_33_TemplateSelector_TwitterTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.TwitterTemplateNormal":
                ...
                xamlMember.Getter = get_34_TemplateSelector_TwitterTemplateNormal;
                xamlMember.Setter = set_34_TemplateSelector_TwitterTemplateNormal;
                break;
            case "InfoHub.Helpers.TemplateSelector.WeatherTemplateHero":
                ...
                xamlMember.Getter = get_35_TemplateSelector_WeatherTemplateHero;
                xamlMember.Setter = set_35_TemplateSelector_WeatherTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.WeatherTemplateNormal":
                ...
                xamlMember.Getter = get_36_TemplateSelector_WeatherTemplateNormal;
                xamlMember.Setter = set_36_TemplateSelector_WeatherTemplateNormal;
                break;
            case "InfoHub.Helpers.TemplateSelector.YouTubeTemplateHero":
                ...
                xamlMember.Getter = get_37_TemplateSelector_YouTubeTemplateHero;
                xamlMember.Setter = set_37_TemplateSelector_YouTubeTemplateHero;
                break;
            case "InfoHub.Helpers.TemplateSelector.YouTubeTemplateNormal":
                ...
                xamlMember.Getter = get_38_TemplateSelector_YouTubeTemplateNormal;
                xamlMember.Setter = set_38_TemplateSelector_YouTubeTemplateNormal;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.Latitude":
                ...
                xamlMember = new global::InfoHub.InfoHub_XamlTypeInfo.XamlMember(this, "Latitude", "Double");
                xamlMember.Getter = get_39_AdControl_Latitude;
                xamlMember.Setter = set_39_AdControl_Latitude;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.Longitude":
                userType = (global::InfoHub.InfoHub_XamlTypeInfo.XamlUserType)GetXamlTypeByName("Microsoft.Advertising.WinRT.UI.AdControl");
                xamlMember = new global::InfoHub.InfoHub_XamlTypeInfo.XamlMember(this, "Longitude", "Double");
                xamlMember.Getter = get_40_AdControl_Longitude;
                xamlMember.Setter = set_40_AdControl_Longitude;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.AdUnitId":
                ...
                xamlMember.Getter = get_41_AdControl_AdUnitId;
                xamlMember.Setter = set_41_AdControl_AdUnitId;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.ApplicationId":
                ...
                xamlMember.Getter = get_42_AdControl_ApplicationId;
                xamlMember.Setter = set_42_AdControl_ApplicationId;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.IsEngaged":
                ...
                xamlMember.Getter = get_43_AdControl_IsEngaged;
                xamlMember.SetIsReadOnly();
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.IsAutoRefreshEnabled":
                ...
                xamlMember.Getter = get_44_AdControl_IsAutoRefreshEnabled;
                xamlMember.Setter = set_44_AdControl_IsAutoRefreshEnabled;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.IsPerformanceScrollingEnabled":
                ...
                xamlMember.Getter = get_45_AdControl_IsPerformanceScrollingEnabled;
                xamlMember.Setter = set_45_AdControl_IsPerformanceScrollingEnabled;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.UseStaticAnchor":
                ...
                xamlMember.Getter = get_46_AdControl_UseStaticAnchor;
                xamlMember.Setter = set_46_AdControl_UseStaticAnchor;
                break;
            case "Microsoft.Advertising.WinRT.UI.AdControl.IsSuspended":
                ...
                xamlMember.Getter = get_47_AdControl_IsSuspended;
                xamlMember.SetIsReadOnly();
                break;
            ...
            case "Windows.UI.Color.B":
                ...
                xamlMember.Getter = get_49_Color_B;
                xamlMember.Setter = set_49_Color_B;
                break;
            ...
            case "Windows.UI.Color.R":
                ...
                xamlMember.Getter = get_51_Color_R;
                xamlMember.Setter = set_51_Color_R;
                break;
            }
            return xamlMember;
        }
